...
function Header()
{
    ...
    $this->Cell(80);
    $this->text(220,150,'ATTESTATION DE PRESENCE',1,0,'C');
    $this->Ln(20);
}
...
$pdf ->SetFont('Times','',14);
if($donnee[2]=='1')
{$pdf ->Cell(0,10,"a assist".utf8_decode("é")."(e) aux cours du ".$donnee[2]." ".utf8_decode("é")."re ann".utf8_decode("é")."e du Cycle de Formation"); 
}
else{$pdf ->Cell(0,10,"a assist".utf8_decode("é")."(e) aux cours du ".$donnee[2]." ".utf8_decode("é")."me ann".utf8_decode("é")."e du Cycle de Formation"); 
}
$pdf ->SetXY(80, 310); 
$pdf ->SetFont('Times','B',14);
...
$pdf ->SetXY(50, 340); 
$pdf ->SetFont('Times','',14);
$pdf ->Cell(0,10," Pour l'ann".utf8_decode("é")."e universitaire ".$_POST['annee']);
$pdf ->SetXY(70, 380); 
$pdf ->SetFont('Times','',14);
