...
function Header()
{
    ...
    $this->Cell(80);
    $this->text(220,150,'ATTESTATION D\'INSCRIPTION',1,0,'C');
    $this->Ln(20);
}
...
$pdf ->SetFont('Times','',14);
if($donnee[2]=='1')
{$pdf ->Cell(0,10,"est inscrit(e) en ".$donnee[2]." ".utf8_decode("é")."re ann".utf8_decode("é")."e du Cycle de Formation");} 
{$pdf ->Cell(0,10,"est inscrit(e) en ".$donnee[2]." ".utf8_decode("é")."me ann".utf8_decode("é")."e du Cycle de Formation");}
$pdf ->SetXY(80, 310); 
$pdf ->SetFont('Times','B',14);
